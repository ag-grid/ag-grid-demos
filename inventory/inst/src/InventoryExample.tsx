...
export const InventoryExample: FunctionComponent<Props> = ({
  ...
  // Flat column definitions for institution table, with Actions column first
  const [colDefs] = useState<ColDef[]>([
    ...
    { field: "instID", headerName: "Inst ID", width: 120, filter: true },
    { field: "instName", headerName: "Inst Name", width: 180, filter: true },
    { field: "createdAt", headerName: "Created At", width: 140 },
    { field: "createdBy", headerName: "Created By", width: 140, filter: true },
  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.container} style={{ width: "90%", margin: "0 auto" }}>
        <div className={styles.exampleHeader}>
          <div className={styles.tabs}>
            {Object.entries(statuses).map(([key, displayValue]) => {
              let borderColor = "transparent";
              if (key === "active") borderColor = "#43a047";
              else if (key === "inactive") borderColor = "#BFCDDB";
              else if (key.toLocaleLowerCase() === "draft") borderColor = "#757575";
              return (
                <button

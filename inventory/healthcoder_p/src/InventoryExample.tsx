...
export const InventoryExample: FunctionComponent<Props> = ({
  ...
  // Add checkbox, last name, first name, dob columns
  const [colDefs] = useState<ColDef[]>([
    ...
    //},
    {
      ...
      cellRenderer: (params: any) => (
        <button
          ...
          title="Archive"
          onClick={() => alert(`Archive Project: ${params.data.projectName}`)}
        >
          {/* Archive (box) icon */}
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            <rect x="3" y="3" width="18" height="4" rx="2" fill="#757575" />
            <rect x="5" y="7" width="14" height="14" rx="2" fill="#BDBDBD" />
            <rect x="9" y="12" width="6" height="2" rx="1" fill="#757575" />
          </svg>
        </button>
      ),
      filter: false,
    ...
    },
    {
      ...
      cellRenderer: (params: any) => (
        <button
          ...
          title="View"
          onClick={() => alert(`View Project: ${params.data.projectName}`)}
        >
          {/* Eye icon */}
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            <ellipse cx="12" cy="12" rx="9" ry="6" fill="#1976d2" />
    ...
    { field: "projectId", headerName: "ProjectID", width: 120, filter: true },
    { field: "projectName", headerName: "Project Name", width: 180, filter: true },
    { field: "executedDate", headerName: "Executed Date", width: 140, filter: true },
    
  ]);

  // Example rowData:
  const [rowData] = useState([
    { projectId: "P001", projectName: "Project Alpha", executedDate: "2025-06-01" },
    { projectId: "P002", projectName: "Project Beta", executedDate: "2025-06-05" },
    { projectId: "P003", projectName: "Project Gamma", executedDate: "2025-06-10" },
    { projectId: "P004", projectName: "Project Delta", executedDate: "2025-06-12" },
    { projectId: "P005", projectName: "Project Epsilon", executedDate: "2025-06-15" },
  ]);
